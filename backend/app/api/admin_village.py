...
from app.schemas.admin_village import AdminVillageCreate, AdminVillageBatchCreate, AdminVillageUpdate, AdminVillageOut
from app.crud.admin_village import get_all, get_by_id, create, update, delete, batch_create
...
@router.post("/batch")
def batch_create_api(obj: AdminVillageBatchCreate, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
